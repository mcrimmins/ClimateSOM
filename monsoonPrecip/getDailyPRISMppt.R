...
get_prism_dailys(type="ppt", minDate = "2020-07-01", maxDate = "2020-7-15", keepZip=FALSE)
...
# name layers
names(precip_stack)<-seq.Date(as.Date("2020-07-01"),as.Date("2020-7-15"),1)
# write out raw yearly values
writeRaster(precip_stack,filename="~/RProjects/SOMs/monsoonPrecip/SWUS_070120_071520_PRISM_daily_prcp.grd", overwrite=TRUE)
